    ...
    return (
      <ScrollView style={styles.rootContainer}>
        <Image
          ...
          source={{ uri: vehicleDetails.VehiclePicture }}
        />
      ...
      <View style={styles.section}>
        ...
        <View style={styles.row}>
          ...
          <View style={styles.container}>
            <StarRating
              baseKey={'overall'}
              starRating={vehicleDetails.OverallRating}
            />
          </View>
        </View>
        <View style={styles.row}>
          ...
          <View style={styles.container}>
            <StarRating
              baseKey={'front'}
              starRating={vehicleDetails.OverallFrontCrashRating}
            />
          </View>
        </View>
        <View style={styles.row}>
          ...
          <View style={styles.container}>
            <StarRating
              baseKey={'side'}
              starRating={vehicleDetails.OverallSideCrashRating}
            />
          </View>
        </View>
        <View style={styles.row}>
          ...
          <View style={styles.container}>
            <StarRating
              baseKey={'sidepole'}
              starRating={vehicleDetails.SidePoleCrashRating}
            />
          </View>
        </View>
        <View style={styles.row}>
          ...
          <View style={styles.container}>
            <StarRating
              baseKey={'rollover'}
              starRating={vehicleDetails.RolloverRating}
            />
          </View>
        </View>
      </View>
  ...
  renderCrashPictures(vehicleDetails) {
    return (
      <View style={styles.section}>
        ...
        <Image
          key="FrontCrashPicture"
          style={styles.crashImage}
          source={{ uri: vehicleDetails.FrontCrashPicture }}
        />
        <Image
          key="SideCrashPicture"
          style={styles.crashImage}
          source={{ uri: vehicleDetails.SideCrashPicture }}
        />
        <Image
          key="SidePolePicture"
          style={styles.crashImage}
          source={{ uri: vehicleDetails.SidePolePicture }}
        />
      </View>
    )
  }
